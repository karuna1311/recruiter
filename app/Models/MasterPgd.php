...
class MasterPgd extends Model
{
    use HasFactory,SoftDeletes,MultiTenantModelTrait, Auditable;
    public $table = 'master_pgds';
    protected $fillable = ['user_id','session_master_id','cname_change','cname_change_value','fname','mname','gender','alternate_mobile','adhar_card_no','permanent_address_1','permanent_address_2','permanent_address_3','permanent_city','permanent_state','permanent_district','permanent_taluka','permanent_pin_code','address_not_same','present_address_1','present_address_2','present_address_3','present_city','present_state','present_district','present_taluka','present_pin_code','nriq','nrim','nriw','nation','domicle_maharashtra','region_of_residence','cate','caste_certificate','caste_cert_no','caste_cert_issue_district','caste_cert_appli_no','caste_cert_appli_date','caste_cert_appli_issue_dist','caste_cert_appli_issue_taluka','caste_validity','caste_validity_no','caste_validity_issue_district','caste_validity_appli_no','caste_validity_appli_date','caste_validity_appli_issue_dist','caste_validity_appli_issue_taluka','ncl_cert','ncl_cert_no','ncl_cert_issue_dist','ncl_cert_date','ncl_cert_appli_no','ncl_cert_appli_date','ncl_cert_appli_issue_dist','ncl_cert_appli_issue_taluka','annual_family_income','ews','ews_cert_status','ews_cert_no','ews_cert_issue_dist','ews_cert_appli_no','ews_cert_appli_date','ews_cert_appli_issue_dist','ews_cert_appli_issue_taluka','ph','ph_type','orphan','minority','minority_quota','inservice_quota','inservice_establishment','inservice_join_date','inservice_posting_addr','inservice_establish_noc','inservice_establish_noc_date','inservice_dept_enquiry','inservice_dept_enquiry_details','mbbs_passing_date','mbbs_agg_per','mbbs_internship_date','mci_reg_diploma','diploma_subject','mci_reg_degree','degree_subject','mbbs_dc_in_mh_or_aiims','mbbs_college_type','mbbs_college_name','mbbs_college_outoff_ind_mah','mbbs_college_ind_mah','mbbs_university_ind_mah','aiee','bond_service','bond_service_undertaking','neet_pg_attempt_year','medical_council_reg','medical_council_reg_no','medical_dci_reg','medical_dci_reg_no','security_deposite_seat_type','security_deposite_amount','declaration_status','status_lock'];
