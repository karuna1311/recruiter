                  ...
                  <div class="col-12">
                              ...
                              <div class="row form-group br-bt-1 ">
                                 <div class=" col-md-12">
                                    <div class="custom-control custom-checkbox mb-2 d-flex" >
                                       <input type="checkbox" name="declare1" class="custom-control-input declarecheckbox" id="1">
                                    ...
                                    <div class="custom-control custom-checkbox mb-2 d-flex">
                                       <input type="checkbox" name="declare2" class="custom-control-input declarecheckbox" id="2">
                                    ...
                                    <div class="custom-control custom-checkbox mb-2 d-flex">
                                       <input type="checkbox" name="declare3" class="custom-control-input declarecheckbox" id="3">
                                    ...
                                    <div class="custom-control custom-checkbox mb-2 d-flex">
                                       <input type="checkbox" name="declare4" class="custom-control-input declarecheckbox" id="4">
                                    ...
                                    <div class="custom-control custom-checkbox mb-2 d-flex">
                                       <input type="checkbox" name="declare5" class="custom-control-input declarecheckbox" id="5">
                     ...
                     <tr>
                        ...
                        <td valign="top">
                           <ul>
                              ...
                              <img id="uploadPreview" width="80" height="90" src="assets/img/no-profile-pic-m.gif"></a>
                     ...
                     <tr>
                        ...
                        <td style="border:solid 1px #CCCCCC;"><a href="" onClick="document.getElementById('uploadImageSign').click(); return false" ><img id="SuploadPreview" width="100" height="50" src="assets/img/Sign.gif"
                           ></a><input id="uploadImageSign" type="file" name="sign" onChange="SPreviewImage();" hidden><h5 class="errorHide" id="err_sign"></h5></td>
                        </ul>
                        </td>         
                     </tr>
                  </table>
