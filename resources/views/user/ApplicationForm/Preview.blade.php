                  ...
                  <div class="card-body">
                     <fieldset class="form-fieldset">
                        ...
                        <div class="row form-group ">
                           ...
                           <div class="col-md-2">
                              <p class="uppercase primary_color"><b>{{$previewData->age??'--'}}</b></p>
                           </div>
                           <div class="col-md-2 text-right">
                           ...
                           <div class="col-md-2">
                              <p class="uppercase primary_color"><b>{{$previewData->bankemp??'--'}}</b></p>
                           </div>
                           <div class="col-md-2 text-right">
                           ...
                           <div class="col-md-2">
                              <p class="uppercase primary_color"><b>{{$previewData->marathispeaking??'--'}}</b></p>
                           </div>
                        </div>
                     </fieldset>
                  ...
                  <div class="card-body">
                     <fieldset class="form-fieldset mb-3">
                        ...
                        <div class="certificateDetails">
                           ...
                           <div class="row form-group   ewscertavaildetails">
                              ...
                              <div class="col-md-3">
                                 <p class="uppercase primary_color"><b>{{ App\Traits\Convertors::getDistrictById($previewData->ews_cert_issue_dist)??'--'}}</b></p>
                              </div>
                           </div>
                           @endif
                           ...
                           <div class="row form-group  certdetails">
                              ...
                              <div class="col-md-3">
                                 <p class="uppercase primary_color"><b>{{ App\Traits\Convertors::getDistrictById($previewData->ews_cert_appli_issue_dist)??'--'}}</b></p>
                              </div>
                              <div class="col-md-3 text-right">
                              ...
                              <div class="col-md-3">
                                 <p class="uppercase primary_color"><b>{{ App\Traits\Convertors::getTalukaById( $previewData->ews_cert_appli_issue_taluka )??'--'}}</b></p>
                              </div>
                           </div>
                           @endif
                           ...
                           <div class="row form-group  sccertavaildetails ">
                              ...
                              <div class="col-md-3">
                                 <p class="uppercase primary_color"><b> {{ App\Traits\Convertors::getDistrictById($previewData->caste_cert_issue_district)??'--'}} </b></p>
                              </div>
                           </div>
                           @endif
                           ...
                           <div class="row form-group sccertdetails">
                              ...
                              <div class="col-md-3">
                                 <p class="uppercase primary_color"><b> {{ App\Traits\Convertors::getDistrictById($previewData->caste_cert_appli_issue_dist)??'--'}} </b></p>
                              </div>
                              <div class="col-md-3 text-right">
                              ...
                              <div class="col-md-3">
                                 <p class="uppercase primary_color"><b>{{ App\Traits\Convertors::getTalukaById( $previewData->caste_cert_appli_issue_taluka )??'--'}}</b></p>
                              </div>
                           </div>
                           @endif
                           @if($previewData->caste_certificate=='AVAILABLE')
                           ...
                           <div class="row form-group  CasteValAvail">
                              ...
                              <div class="col-md-3">
                                 <p class="uppercase primary_color"><b>{{  App\Traits\Convertors::getDistrictById($previewData->caste_validity_issue_district)??'--'}} </b></p>
                              </div>
                           </div>
                           @endif
                           ...
                           <div class="row form-group  CasteValApplied">
                              ...
                              <div class="col-md-3">
                                 <p class="uppercase primary_color"><b>{{ App\Traits\Convertors::getDistrictById($previewData->caste_validity_appli_issue_dist)??'--'}}</b></p>
                              </div>
                              <div class="col-md-3 text-right">
                              ...
                              <div class="col-md-3">
                                 <p class="uppercase primary_color"><b>{{ App\Traits\Convertors::getTalukaById( $previewData->caste_validity_appli_issue_taluka )??'--'}}</b></p>
                              </div>
                           </div>
                           @endif
                           <!-- //noncreamy -->
                           @if($previewData->cate=='DT-A' || $previewData->cate=='NT-B' || $previewData->cate=='NT-C' || $previewData->cate=='NT-D' || $previewData->cate=='OBC' || $previewData->cate=='SBC')
                           ...
                           <div class="row form-group  NCLAvail ">
                              ...
                              <div class="col-md-3">
                                 <p class="uppercase primary_color"><b>{{ App\Traits\Convertors::getDistrictById($previewData->ncl_cert_issue_dist)??'--'}}</b></p>
                              </div>
                              <div class="col-md-3 text-right">
                           ...
                           <div class="row form-group   NCLApplied">
                              ...
                              <div class="col-md-3">
                                 <p class="uppercase primary_color"><b>{{ App\Traits\Convertors::getDistrictById($previewData->ncl_cert_appli_issue_dist)??'--'}}</b></p>
                              </div>
                              <div class="col-md-3 text-right">
                              ...
                              <div class="col-md-3">
                                 <p class="uppercase primary_color"><b>{{ App\Traits\Convertors::getTalukaById( $previewData->ncl_cert_appli_issue_taluka )??'--'}} </b></p>
                              </div>
                           </div>
                           @endif
                        </div>
                     ...
                     <fieldset class="form-fieldset ">
                        ...
                        <div class="row form-group br-bt-1">
                           ...
                           <div class="row form-group br-bt-1 mt-2 mb-2 phDetails ">
                              <div class="col-md-3 text-right">
                              ...
                              <tbody>
                                 ...
                                 <tr>
                                    ...
                                    <td>{{ !empty($value->name) ? $value->name : '-'}}</td>
                                     ...
                                     <td>{{ !empty($value->status==1) ? 'Eligible' : 'Non-Eligible'}}</td>
                                     <td>{{ !empty($value->application_no) ? $value->application_no : '-'}}</td>
                                     <td>{{ !empty($value->payment_status=="SUCCESS") ? $value->payment_status : 'NOT PAID'}}</td>
